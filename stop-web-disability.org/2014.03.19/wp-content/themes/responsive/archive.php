            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="post-entry">
                    ...
                    <?php if ( has_post_thumbnail()) : ?>
                        <a href="<?php the_permalink(); ?>" class="post-expert-thumb" title="<?php the_title_attribute(); ?>" >
                    <?php the_post_thumbnail('thumbnail', array('class' => 'alignleft')); ?>
                        </a>
                    <?php endif; ?>


                     <a  class="archive-post-title" href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__( 'Permanent Link to %s', 'responsive' ), the_title_attribute( 'echo=0' )); ?>"><h2><?php the_title(); ?></h2>
