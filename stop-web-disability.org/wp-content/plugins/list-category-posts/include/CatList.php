  ...
  public function get_thumbnail($single, $lcp_thumb_class = null){
    ...
    if ($this->params['thumbnail']=='yes'):
      ...
      if ( has_post_thumbnail($single->ID) ):
        ...
        // dudin
        $lcp_thumb_size = array(75,75);

        $lcp_thumbnail = '<a class="thumbnail_container" href="' . get_permalink($single->ID).'" title="' . $single->post_title . '">';
      ...
      elseif (
        ...
        if ($lcp_thumb_class != null):
          $thmbn_class = ' class="thumbnail_container ' . $lcp_thumb_class . '" />';
        $lcp_ytimage = preg_replace("/\>/", $thmbn_class, $lcp_ytimage);
        endif;

        $lcp_thumbnail .= '<a class="thumbnail_container" href="' . get_permalink($single->ID).'">' . $lcp_ytimage . '</a>';
